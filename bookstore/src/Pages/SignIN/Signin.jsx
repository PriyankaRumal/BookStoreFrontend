    ...
    return(
        <div className="mainClass">
            <div className="ImagePart">
              <img className="img1" src='https://public-v2links.adobecc.com/d096df37-ca37-4026-553f-8cfa6bec09ec/component?params=component_id%3A634ba680-536e-4b6f-b4a3-41986b9b22f5&params=version%3A0&token=1679987832_da39a3ee_9820b78e198b568830a7752f8eee88a1dfe0b701&api_key=CometServer1' />
